...
public static class Extensions
{
    ...
    public static string Path(this GameObject obj, Transform upTo = null)
    {
        string path = "/" + obj.name;
        while (obj.transform.parent != upTo && obj.transform.parent != null)
        {
    ...
    public static string Path(this Transform transform, Transform upTo = null)
    {
        string path = transform.name;
        while (transform.parent != upTo && transform.parent != null)
        {
